...
#define cs_maxNumCarsInUDPData 22

#include <cstdint>

#pragma pack(push, 1)

// 1. Packet Header (Always on top, common to all packets)
struct PacketHeader {
...
// 2. Motion Packet (The motion packet gives physics data for all the cars being driven)
...
struct LapData {
    ...
    uint8_t m_carPosition; // Car race posit
...
// 10. Final Classification Packet
